...
export const RELEASE =
  "https://github.com/tronschell/shinbo/releases/tag/v0.8.2";
const ASSETS = "https://github.com/tronschell/shinbo/releases/download/v0.8.2/";
export const platforms = {
  ...
  mac: {
    ...
    href: ASSETS + "Shinbo-v0.8.2-darwin-arm64.dmg",
  ...
  windows: {
    ...
    href: ASSETS + "Shinbo-v0.8.2-win32-x64-Setup.exe",
