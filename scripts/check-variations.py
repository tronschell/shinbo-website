...
for number in range(1, 7):
    ...
    assert any(link.endswith("Shinbo-v0.8.1-darwin-arm64.dmg") for link in links), (path, "verified Mac download")
    assert any(link.endswith("Shinbo-v0.8.1-win32-x64-Setup.exe") for link in links), (path, "verified Windows download")
